...
with DAG('kafka_docker_terminator',
    ...
    docker_task = BashOperator(
        task_id='start_kafka',
        bash_command='cd /Users/abeee/data_engineering/docker/confluent-kafka && docker-compose down'

    )

    success_task = BashOperator(
        task_id='kafka_stopped',
        bash_command='echo "Kafka Docker containers started successfully."'
    )

    failure_task = BashOperator(
        task_id='kafka_stop_failed',
